...
import os
source_resources = os.getcwd()
print "source_resources", source_resources
banner = '/'.join((source_resources, "imageresizer/resources/img/banner.jpg"))
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.banner.setPixmap(QtGui.QPixmap(banner))
